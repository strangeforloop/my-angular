...
describe('Scope', function() {
  ...
  // test case asserts that you can register a watcher using $watch
  // and that the watcher's listener function is invoked when someone
  // calls $digest
  ...
  describe('digest', function () {
    ...
    it('calls the listener function when the watched value chagnes', function() {
      scope.someValue = 'a';
      scope.counter = 0;
    ...
    it('allows destoying a $watch during digest', function() {
      scope.aValue = 'abc';
  ...
  describe('inheritance', function() {
    ...
    it('does not shadow members of parent scopes attributes', function() {
      ...
      // you're not creating anything new on the child object
      // instead, you're accessing the user from the parent
      child.user.name = 'Jill';

      expect(child.user.name).toEqual('Jill');
      expect(parent.name).toEqual('Jill');
    });
...
describe('$eval', function() {
  ...
  it('passes the second $eval argument straight through', function() {
    ...
    // eval takes a function as an argument (and optional args) 
    // and immediately executes
    // the function, returning the result of the execution
...
describe('$evalAsync', function() {
  ...
  it('catch exceptions in $evalAsync', function(done) {
    scope.aValue = 'abc';
    scope.counter = 0;
...
describe('$applyAsync', function () {
  ...
  it('cancels and flushs $applyAsync if digested first', function(done) {
    scope.counter = 0;
